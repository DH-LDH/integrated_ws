...
ROBOT_CONFIGS = {
    "robot1": {
        ...
        ###  대회장
        "drop_joint": [-90.0, 15.72, 86.41, 0.02, 77.88, 2.81],
        ...
        "drop_after_drop_joint": [-101.78, -12.78, 150.08, 0.32, -27.07, -4.22],
    ...
    "robot2": {
        ...
        ##대회용 
        "separation_joint": [-90.02, -9.83, 112.31, 0.0, -15.0, -0.40], ###### 맵에서 속도 \줄여서 다시 측정
        "drop_joint": [-95.0, 14.95, 135.16, 0.0, -52.4, 0.0],
        "drop_joint2": [-95.0, 9.82, 135.36, 0.0, -47.45, 0.0], # 2,3층 시퀀스만 해당
        "drop_joint3": [-95.0, 6.1, 135.25, 0.0, -43.63, 0.0], # 4층 시퀀스
        "drop_joint4": [-100.0, 14.95, 135.16, 0.0, -52.4, 0.0],  # 큰 나무 2층 콤보용 (캘리브레이션 필요)
